...
export function Hero() {
  ...
  const parallax = reducedMotion ? 0 : Math.min(scrolled * 0.28, 180);
  const fade = reducedMotion ? 1 : Math.max(0, 1 - scrolled / 600);
  const textShift = reducedMotion ? 0 : scrolled * 0.15;
